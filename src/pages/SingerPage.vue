  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="select_word" size="mini" style="width: 300px; display: inline-block;" placeholder="请输入歌手名"
    ...
    <el-dialog title="添加歌手" :visible.sync="centerDialogVisible" width="400px" center>
      ...
      <span slot="footer">
        ...
        <el-button size="mini" type="primary" @click="addSinger">确定</el-button>
      </span>
    </el-dialog>
    <!-- 修改 -->
    <el-dialog title="修改歌手" :visible.sync="editVisible" width="400px" center>
      ...
      <span slot="footer">
        ...
        <el-button size="mini" type="primary" @click="editSinger">确定</el-button>
      </span>
    </el-dialog>
    <!-- 删除 -->
