  ...
  <div class="table">
    ...
    <el-dialog title="修改歌曲" :visible.sync="editVisible" width="400px" center>
      ...
      <span slot="footer">
        ...
        <el-button size="mini" type="primary" @click="editSong">确定</el-button>
      </span>
    </el-dialog>
    <!-- 删除 -->
...
export default {
  ...
  methods: {
    ...
    parseLyric(text) {
      ...
      // let pattern = /\[\d{2}:\d{2}.(\d{3}|\d{2})\]/g;//精确到毫秒2位或3位
